...
int main(void)
{
    ...
    Account *account_ptr = (Account *) Obj_WS_ptr; //casting Obj_WS_ptr to Account type, then stored in account_ptr
    
    //print the addresses for class components:
    std::cout << "Address of A1, Account: " << &(Obj_WS_ptr->A1) << std::endl;
    ...
    std::cout << "Address under Account Casting: " << (Account *) Obj_WS_ptr << std::endl; //casting Obj_WS_ptr to Account type
